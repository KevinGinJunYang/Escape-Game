 ...
 *
 */
public class BoxElement extends GameItemElement {
   ...
   */
  public BoxElement(GameObject gameElement, int playerCol, int playerRow, int objectCol,
    ...
    super(gameElement, playerCol, playerRow, objectCol, objectRow, cellWidth, cellHeight,
        frontWallWidth, frontWallHeight, xoffset, BoxElement.IMAGE_SCALE);
